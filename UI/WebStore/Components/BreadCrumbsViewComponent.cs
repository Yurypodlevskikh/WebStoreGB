...
namespace WebStore.Components
{
    public class BreadCrumbsViewComponent : ViewComponent
    {
        ...
        {
            Type = Request.Query.ContainsKey("SectionId") ? BreadCrumbType.Section 
                : Request.Query.ContainsKey("BrandId") ? BreadCrumbType.Brand : BreadCrumbType.None;
            ...
            switch(Type)
            {
                ...
                case BreadCrumbType.Product:
                    ...
                    // FromBrand - attribute from first item in the features_items list on _FeaturesItems Partial View
                ...
                case BreadCrumbType.Product:
                    ...
                    return View(new[]
                    {
                        new BreadCrumbsViewModel
                        {
                            ...
                            Id = from_type == BreadCrumbType.Section ? product.Section.Id : product.Brand.Id,
                            Name = from_type == BreadCrumbType.Section ? product.Section.Name : product.Brand.Name
                        },
                        new BreadCrumbsViewModel
                        {
